...
static const int64 MIN_MINT_PROOF_OF_WORK = 5 * COIN;
...
static const uint256 hashGenesisBlockOfficial("0xde0cd12da10019356d4ebee82d243272b9fb1c9288302d6750d0ff0ebb0dad73");
static const uint256 hashGenesisBlockTestNet("0xb796ed0f4efd5ecf1af2caba285f4b5c5685810f041b0ba160b0ad8f90221a23");
...
// arcoin: calculate Nfactor using timestamp
...
public:
    ...
    uint256 GetHash() const
    {
        ...
        return Hash9(BEGIN(nVersion), END(nNonce));
         ...
         uint256 thash;
         scrypt_hash(CVOIDBEGIN(nVersion), sizeof(CBlockHeader), UINTBEGIN(thash), GetNfactor(nTime));
         return thash;
        }
    }
...
public:
    ...
    {
        // Protocol switch to support p2pool at arcoin block #9689
        //if (nHeight >= 9689)
        {
        ...
        /*// Before arcoin block #9689 - old protocol
